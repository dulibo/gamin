 ...
 */
// 佳明中国区账号及密码
export const GARMIN_USERNAME_DEFAULT = 'dulibo1230123@163.com';
export const GARMIN_PASSWORD_DEFAULT = 'Dulibo11..';
// 佳明国际区区账号及密码
export const GARMIN_GLOBAL_USERNAME_DEFAULT = 'dulibo1230123@163.com';
export const GARMIN_GLOBAL_PASSWORD_DEFAULT = 'Dulibo11..';
// 佳明迁移数量配置
export const GARMIN_MIGRATE_NUM_DEFAULT = 1;
